---
title: "CodeEff_Matrix Example"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{CodeEff_Matrix Example}
...
# Create the initial estimator matrix
zeta.int <- matrix(0, 4000, 10)  # Replace with appropriate dimensions
